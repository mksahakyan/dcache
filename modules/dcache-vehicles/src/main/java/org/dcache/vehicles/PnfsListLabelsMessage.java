...
public class PnfsListLabelsMessage extends PnfsMessage {
    ...
    private static final long serialVersionUID = -2413621931920307642L;
     ...
     *
     * @param path    Parent path to labels listing
     ...
     */
    public PnfsListLabelsMessage(String path, Glob pattern,
                                 Range<Integer> range,
