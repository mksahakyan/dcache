...
public class ChimeraResource {
    ...
    public String getFileStatus(@PathParam("fileid") String fileid) throws IOException, CacheException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>> test for pnfsID" + ctx + (ctx.getAttribute(FS)).getClass().getName());
    ...
    @GET
    @Path("/login/{fileid}/{pass}")
    @Produces("text/plain")
    public String login(@PathParam("fileid") String fileid, ) throws IOException, CacheException, ClassNotFoundException, IllegalAccessException, InstantiationException {
